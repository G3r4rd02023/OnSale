...
namespace OnSale.Web.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckUserAsync("1010", "Gerardo", "Lanza", "glanza007@gmail.com", "322 311 4620", "Calle Luna Calle Sol", UserTypes.Admin);
        }
            ...
            if (!_context.Countries.Any())
            {
                    ...
                    Departments = new List<Department>
                {
                    new Department
                    {
                        ...
                        {
                            new City { Name = "Distrito Central" },
